module.factory('dataService', function ($http, $q) {
    ...
    service.Login = function (username, password) {
        ...
        $http.post(url + '/Login', loginRequest, { headers: { "Content-Type": "application/x-www-form-urlencoded" } }).
    ...
    service.PostContactInfo = function (contactInfo) {
        var deferred = $q.defer();

        $http.post(url + '/api/contactinfo/', contactInfo, { headers: { 'Authorization': 'Bearer ' + sessionStorage.getItem("accessToken") } }).
        success(function (data, status, headers, config) {
            deferred.resolve(data);
        }).
        error(function (data, status, headers, config) {
    ...
    service.ChangePassword = function (changePasswordViewModel) {
        ...
        $http.post(url + '/api/changepassword/', changePasswordViewModel, { headers: { 'Authorization': 'Bearer ' + sessionStorage.getItem("accessToken") } }).
        success(function (data, status, headers, config) {
            deferred.resolve(data);
        }).
        error(function (data, status, headers, config) {
    ...
    service.Register = function (registerViewModel) {
        ...
        $http.post(url + '/api/register/', registerViewModel).
        success(function (data, status, headers, config) {
            deferred.resolve(data);
        }).
        error(function (data, status, headers, config) {
